...
downenter:0,downFn:function(){var b=r.outerHeight();r.css({top:a("a:first",m).slice(0,1).position().top-b})}});var b;a("a",g).enterleave({enterdata:"letter",enterT:300,enterdown:0,enterFn:function(f){b=f;f=b.attr("class").split(" ")[0];var d=k.children(".ln-no-match");if(p!==f){a("a.ln-selected",g).removeClass("ln-selected");if("all"===f)k.children().addClass("listNavShow").removeClass("listNavHide"),d.addClass("listNavHide").removeClass("listNavShow"),t=!0;else{t?(k.children().addClass("listNavHide").removeClass("listNavShow"),
...
leaveFn:function(b){}})}function B(){for(var b=[],a=1;a<d.length;a++)0===b.length&&b.push('<a class="all" href="#">'+y+'</a><a class="_" href="#">'+z+"</a>"),b.push('<a class="'+d[a]+'" href="#">'+("-"===d[a]?"...":d[a].toUpperCase())+"</a>");return'<div class="ln-letters">'+b.join("")+"</div>"+(c.showCounts?'<div class="ln-letter-count listNavHide">0</div>':"")}var g,r,u=this.id,k=a(this),l={},x=0,t=!0,p="";a("#"+u+"-nav").length||a('<div id="'+u+'-nav" class="listNav"/>').insertBefore(k);var m=
a("#"+u+"-nav");(function(){m.append(B());g=(".ln-letters",m).slice(0,1);c.showCounts&&(r=a(".ln-letter-count",m).slice(0,1));q();k.append('<li class="ln-no-match listNavHide">'+c.noMatchText+"</li>");A();if(c.flagDisabled)for(var b=0;b<d.length;b++)void 0===l[d[b]]&&a("."+d[b],g).addClass("ln-disabled");c.includeAll||a(".all",g).remove();c.includeNums||a("._",g).remove();c.includeOther||a(".-",g).remove();c.removeDisabled&&a(".ln-disabled",g).remove();a(":last",g).addClass("ln-last");a.cookie&&null!==
c.cookieName&&(b=a.cookie(c.cookieName),null!==b&&(c.initLetter=b));if(""!==c.initLetter)n=!0,a("."+c.initLetter.toLowerCase(),g).slice(0,1).trigger(v);else if(c.includeAll)a(".all",g).addClass("ln-selected");else for(b=c.includeNums?0:1;b<d.length;b++)if(0<l[d[b]]){n=!0;a("."+d[b],g).slice(0,1).trigger(v);break}})()})};a.fn.listnav.defaults={allText:"All",numberText:"#",initLetter:"",includeAll:!0,incudeOther:!1,includeNums:!0,flagDisabled:!0,removeDisabled:!1,noMatchText:"No matching entries",showCounts:!0,
cookieName:null,onClick:null,prefixes:[],filterSelector:""}})(jQuery);
